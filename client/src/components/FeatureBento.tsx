        ...
        <div className="grid gap-4 md:gap-5">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-5">
            <motion.div
              ...
              className="relative overflow-hidden rounded-xl sm:rounded-2xl border border-white/[0.08] bg-white/[0.02] p-3 sm:p-8 md:p-12"
            >
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-5">
            {FEATURE_CARDS.map((card, i) => (
              <motion.div
                ...
                className="relative overflow-hidden rounded-xl sm:rounded-2xl border border-white/[0.08] bg-white/[0.02] p-3 sm:p-6 md:p-8"
              >
